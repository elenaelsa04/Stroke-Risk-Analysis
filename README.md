...
│   ├── avg_age_by _smoking_status.png
│   ├── avg_age_by_stroke _status.png
│   ├── bmi_by_stroke.png
│   ├── bmi_distribution.png
│   ├── correlation_heatmap.png
│   ├── glucose_by_stroke.png
│   ├── patient__distribution_by__age.png
│   ├── patient_distribution_by _gender.png
│   ├── smoking_status _distribution.png
│   ├── stroke_cases_by heart_disease.png
│   ├── stroke_cases_by hypertension.png
...
![Dashboard 1](visual1.png)
![Dashboard 2](visual2.png)
![Dashboard 3](visual3.png)
